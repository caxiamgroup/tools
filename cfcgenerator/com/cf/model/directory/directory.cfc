<cfcomponent output="false">
	<cfproperty name="directoryName" type="string" required="true" />
	...
	<cffunction name="init" access="public" output="false" returntype="directory">
		...
		<cfset setDirectoryName(arguments.directoryName) />
	...
	<cffunction name="setDirectoryName" access="public" output="false" returntype="void">
		<cfargument name="directoryName" type="string" required="true" />
		
		<cfset variables.directoryName = arguments.directoryName />
	</cffunction>
	<cffunction name="getDirectoryName" access="public" output="false" returntype="string">
